...
<body>
  ...
  <div class="container"> 
    ...
    <div class="row cont_img_accesoerror mt-2 mb-5"> 
      ...
      <div class="text-center lead mt-5 mb-5"><h3><strong>ACCESO EXCLUSIVO PARA ENCARGADO</strong></h3>
     
     <div class='text-center lead mt-5 mb-5'><h3><strong>BIENVENIDO/A AL PANEL DEL ENCARGADO!!!</strong></h3> </div>  
